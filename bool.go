...
// LinkWithParent implements the BoolNode interface.
//
...
// GetLeaves implements the BoolNode interface.
//
...
func (tn *BoolNode) GetLeaves() []*BoolNode {
	...
	stack := Stacker.NewLinkedStack[*BoolNode](tn)
...
// GetAncestors implements the BoolNode interface.
//
...
// GetFirstChild implements the BoolNode interface.
func (tn *BoolNode) GetFirstChild() *BoolNode {
	return tn.FirstChild
}

// DeleteChild implements the BoolNode interface.
//
