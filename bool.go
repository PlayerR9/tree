...
func (b *Bool) Iterator() common.Iterater[Noder] {
	return &BoolIterator{
		parent: b,
...
func (b *Bool) Copy() common.Copier {
...
func (b *Bool) SetParent(parent Noder) bool {
	if parent == nil {
		b.Parent = nil
		return true
	}
...
func (b *Bool) LinkChildren(children []Noder) {
	if len(children) == 0 {
		return
	}
...
//
// Finally, no nil nodes are returned.
func (b *Bool) GetAncestors() []Noder {
	var ancestors []Noder
...
func (b *Bool) DeleteChild(target Noder) []Noder {
	if target == nil {
		return nil
	}
...
func (b *Bool) AddChild(child Noder) {
	if child == nil {
		return
	}
...
func (b *Bool) GetLastSibling() *Bool {
	if b.Parent != nil {
...
func (b *Bool) GetFirstSibling() *Bool {
	if b.Parent != nil {
...
func (b *Bool) AddChildren(children []*Bool) {
	if len(children) == 0 {
		return
	}
...
func (b *Bool) HasChild(target *Bool) bool {
...
// Returns:
//   - []Noder: A slice of pointers to the children of the node.
func (b *Bool) delete_child(target *Bool) []Noder {
...
func (b *Bool) IsChildOf(target *Bool) bool {
	if target == nil {
		return false
	}
