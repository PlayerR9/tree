...
//
// Moreover, the return value is always of type *ByteNode and never nil; unless the iterator
// has reached the end of the branch.
func (iter *ByteNodeIterator) Consume() (tree.Noder, error) {
	if iter.current == nil {
...
func (tn *ByteNode) GetParent() tree.Noder {
	return tn.Parent
}
...
func (tn *ByteNode) Cleanup() []tree.Noder {
...
func (tn *ByteNode) DeleteChild(target tree.Noder) []tree.Noder {
	if target == nil {
		return nil
	}

	tmp, ok := target.(*ByteNode)
	if !ok {
		return nil
	}
...
func (tn *ByteNode) GetFirstChild() tree.Noder {
	return tn.FirstChild
}

// AddChild implements the tree.Noder interface.
func (tn *ByteNode) AddChild(target tree.Noder) {
	if target == nil {
		return
	}
...
func (tn *ByteNode) LinkChildren(children []tree.Noder) {
...
func (tn *ByteNode) RemoveNode() []tree.Noder {
	prev := tn.PrevSibling
	next := tn.NextSibling
	parent := tn.Parent
...
func (tn *ByteNode) Copy() tree.Noder {
...
// values is guaranteed to be a non-nil node of type ByteNode.
func (tn *ByteNode) Iterator() common.Iterater[tree.Noder] {
...
func (tn *ByteNode) String() string {
	return fmt.Sprintf("ByteNode[%v]", tn.Data)
}
