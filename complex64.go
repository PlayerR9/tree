...
// node is never nil.
func (iter *Complex64NodeIterator) Consume() (*Complex64Node, error) {
	if iter.current == nil {
...
// Iterator implements the Complex64Node interface.
//
// This function iterates over the children of the node, it is a pull-based iterator,
// and never returns nil.
func (tn *Complex64Node) Iterator() common.Iterater[*Complex64Node] {
...
// String implements the Complex64Node interface.
...
// LinkWithParent implements the Complex64Node interface.
//
...
// GetLeaves implements the Complex64Node interface.
//
...
func (tn *Complex64Node) GetLeaves() []*Complex64Node {
	...
	stack := Stacker.NewLinkedStack[*Complex64Node](tn)

	var leaves []*Complex64Node
...
// Cleanup implements the Complex64Node interface.
//
...
// GetAncestors implements the Complex64Node interface.
//
...
//
// Finally, no nil nodes are returned.
func (tn *Complex64Node) GetAncestors() []*Complex64Node {
	var ancestors []*Complex64Node
...
// IsLeaf implements the Complex64Node interface.
func (tn *Complex64Node) IsLeaf() bool {
	return tn.FirstChild == nil
}

// IsSingleton implements the Complex64Node interface.
func (tn *Complex64Node) IsSingleton() bool {
	return tn.FirstChild != nil && tn.FirstChild == tn.LastChild
}

// GetFirstChild implements the Complex64Node interface.
func (tn *Complex64Node) GetFirstChild() *Complex64Node {
	return tn.FirstChild
}

// DeleteChild implements the Complex64Node interface.
//
...
// Size implements the Complex64Node interface.
//
...
func (tn *Complex64Node) AddChild(child *Complex64Node) {
	if child == nil {
		return
	}
