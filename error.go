...
// node is never nil.
func (iter *ErrorNodeIterator) Consume() (*ErrorNode, error) {
	if iter.current == nil {
...
// String implements the ErrorNode interface.
...
// LinkWithParent implements the ErrorNode interface.
//
...
// GetLeaves implements the ErrorNode interface.
//
...
func (tn *ErrorNode) GetLeaves() []*ErrorNode {
	...
	stack := Stacker.NewLinkedStack[*ErrorNode](tn)

	var leaves []*ErrorNode
...
// Cleanup implements the ErrorNode interface.
//
...
// GetAncestors implements the ErrorNode interface.
//
...
//
// Finally, no nil nodes are returned.
func (tn *ErrorNode) GetAncestors() []*ErrorNode {
	var ancestors []*ErrorNode
...
// IsLeaf implements the ErrorNode interface.
func (tn *ErrorNode) IsLeaf() bool {
	return tn.FirstChild == nil
}

// IsSingleton implements the ErrorNode interface.
func (tn *ErrorNode) IsSingleton() bool {
	return tn.FirstChild != nil && tn.FirstChild == tn.LastChild
}

// GetFirstChild implements the ErrorNode interface.
func (tn *ErrorNode) GetFirstChild() *ErrorNode {
	return tn.FirstChild
}

// DeleteChild implements the ErrorNode interface.
//
...
// Size implements the ErrorNode interface.
//
...
func (tn *ErrorNode) AddChild(child *ErrorNode) {
	if child == nil {
		return
	}
