...
// node is never nil.
func (iter *Float64NodeIterator) Consume() (*Float64Node, error) {
	if iter.current == nil {
...
// Iterator implements the Float64Node interface.
//
// This function iterates over the children of the node, it is a pull-based iterator,
// and never returns nil.
func (tn *Float64Node) Iterator() common.Iterater[*Float64Node] {
...
// String implements the Float64Node interface.
...
// LinkWithParent implements the Float64Node interface.
//
...
// GetLeaves implements the Float64Node interface.
//
...
func (tn *Float64Node) GetLeaves() []*Float64Node {
	...
	stack := Stacker.NewLinkedStack[*Float64Node](tn)

	var leaves []*Float64Node
...
// Cleanup implements the Float64Node interface.
//
...
// GetAncestors implements the Float64Node interface.
//
...
//
// Finally, no nil nodes are returned.
func (tn *Float64Node) GetAncestors() []*Float64Node {
	var ancestors []*Float64Node
...
// IsLeaf implements the Float64Node interface.
func (tn *Float64Node) IsLeaf() bool {
	return tn.FirstChild == nil
}

// IsSingleton implements the Float64Node interface.
func (tn *Float64Node) IsSingleton() bool {
	return tn.FirstChild != nil && tn.FirstChild == tn.LastChild
}

// GetFirstChild implements the Float64Node interface.
func (tn *Float64Node) GetFirstChild() *Float64Node {
	return tn.FirstChild
}

// DeleteChild implements the Float64Node interface.
//
...
// Size implements the Float64Node interface.
//
...
func (tn *Float64Node) AddChild(child *Float64Node) {
	if child == nil {
		return
	}
