...
func (iter *IntIterator) Restart() {
	iter.current = iter.parent.FirstChild
}

// Int is a node in a tree.
type Int struct {
	Parent, FirstChild, NextSibling, LastChild, PrevSibling *Int
	Data int
}
...
func (i1 *Int) SetParent(parent Noder) bool {
	if parent == nil {
		i1.Parent = nil
		return true
	}
...
func (i1 *Int) GetParent() Noder {
	return i1.Parent
}

// LinkWithParent implements the Noder interface.
//
// Children that are not of type *Int or nil are ignored.
func (i1 *Int) LinkChildren(children []Noder) {
	if len(children) == 0 {
		return
	}

	var valid_children []*Int
...
//
// Finally, no nil nodes are returned.
func (i1 *Int) GetAncestors() []Noder {
	var ancestors []Noder
...
func (i1 *Int) DeleteChild(target Noder) []Noder {
	if target == nil {
		return nil
	}
...
func (i1 *Int) AddChild(child Noder) {
	if child == nil {
		return
	}
...
// NewInt creates a new node with the given data.
//
// Parameters:
//   - Data: The Data of the node.
//
// Returns:
//   - *Int: A pointer to the newly created node. It is
//   never nil.
...
//
// Returns:
//   - *Int: A pointer to the last sibling.
func (i1 *Int) GetLastSibling() *Int {
	if i1.Parent != nil {
...
//
// Returns:
//   - *Int: A pointer to the first sibling.
func (i1 *Int) GetFirstSibling() *Int {
	if i1.Parent != nil {
...
func (i1 *Int) HasChild(target *Int) bool {
...
// Returns:
//   - []Noder: A slice of pointers to the children of the node.
func (i1 *Int) delete_child(target *Int) []Noder {
...
func (i1 *Int) IsChildOf(target *Int) bool {
	if target == nil {
		return false
	}
