...
func (i1 *Int16) Iterator() common.Iterater[Noder] {
...
func (i1 *Int16) Copy() common.Copier {
...
func (i1 *Int16) SetParent(parent Noder) bool {
	if parent == nil {
		i1.Parent = nil
		return true
	}
...
func (i1 *Int16) LinkChildren(children []Noder) {
	if len(children) == 0 {
		return
	}
...
//
// Finally, no nil nodes are returned.
func (i1 *Int16) GetAncestors() []Noder {
	var ancestors []Noder
...
func (i1 *Int16) DeleteChild(target Noder) []Noder {
	if target == nil {
		return nil
	}
...
func (i1 *Int16) AddChild(child Noder) {
	if child == nil {
		return
	}
...
//	└── 5
//	└── 6
func (i1 *Int16) RemoveNode() []Noder {
	prev := i1.PrevSibling
	next := i1.NextSibling
	parent := i1.Parent
...
func (i1 *Int16) GetLastSibling() *Int16 {
	if i1.Parent != nil {
...
func (i1 *Int16) GetFirstSibling() *Int16 {
	if i1.Parent != nil {
...
func (i1 *Int16) AddChildren(children []*Int16) {
	if len(children) == 0 {
		return
	}
...
func (i1 *Int16) GetChildren() []Noder {
	var children []Noder
...
func (i1 *Int16) HasChild(target *Int16) bool {
...
// Returns:
//   - []Noder: A slice of pointers to the children of the node.
func (i1 *Int16) delete_child(target *Int16) []Noder {
...
func (i1 *Int16) IsChildOf(target *Int16) bool {
	if target == nil {
		return false
	}
