...
// node is never nil.
func (iter *Int16NodeIterator) Consume() (*Int16Node, error) {
	if iter.current == nil {
...
// String implements the Int16Node interface.
...
// LinkWithParent implements the Int16Node interface.
//
...
// GetLeaves implements the Int16Node interface.
//
...
func (tn *Int16Node) GetLeaves() []*Int16Node {
	...
	stack := Stacker.NewLinkedStack[*Int16Node](tn)

	var leaves []*Int16Node
...
// Cleanup implements the Int16Node interface.
//
...
// GetAncestors implements the Int16Node interface.
//
...
//
// Finally, no nil nodes are returned.
func (tn *Int16Node) GetAncestors() []*Int16Node {
	var ancestors []*Int16Node
...
// IsLeaf implements the Int16Node interface.
func (tn *Int16Node) IsLeaf() bool {
	return tn.FirstChild == nil
}

// IsSingleton implements the Int16Node interface.
func (tn *Int16Node) IsSingleton() bool {
	return tn.FirstChild != nil && tn.FirstChild == tn.LastChild
}

// GetFirstChild implements the Int16Node interface.
func (tn *Int16Node) GetFirstChild() *Int16Node {
	return tn.FirstChild
}

// DeleteChild implements the Int16Node interface.
//
...
// Size implements the Int16Node interface.
//
...
func (tn *Int16Node) AddChild(child *Int16Node) {
	if child == nil {
		return
	}
