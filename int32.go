...
// Int32Iterator is a pull-based iterator that iterates
// over the children of a Int32.
type Int32Iterator struct {
	parent, current *Int32
}
...
// node is never nil.
func (iter *Int32Iterator) Consume() (Noder, error) {
	if iter.current == nil {
...
func (iter *Int32Iterator) Restart() {
	iter.current = iter.parent.FirstChild
}

// Int32 is a node in a tree.
type Int32 struct {
	Parent, FirstChild, NextSibling, LastChild, PrevSibling *Int32
	Data int32
}
...
func (i1 *Int32) Iterator() common.Iterater[Noder] {
...
func (i1 *Int32) Copy() common.Copier {
...
func (i1 *Int32) SetParent(parent Noder) bool {
	if parent == nil {
		i1.Parent = nil
		return true
	}
...
func (i1 *Int32) GetParent() Noder {
	return i1.Parent
}

// LinkWithParent implements the Noder interface.
//
// Children that are not of type *Int32 or nil are ignored.
func (i1 *Int32) LinkChildren(children []Noder) {
	if len(children) == 0 {
		return
	}

	var valid_children []*Int32
...
//
// Finally, no nil nodes are returned.
func (i1 *Int32) GetAncestors() []Noder {
	var ancestors []Noder
...
func (i1 *Int32) DeleteChild(target Noder) []Noder {
	if target == nil {
		return nil
	}
...
func (i1 *Int32) AddChild(child Noder) {
	if child == nil {
		return
	}
...
//	└── 5
//	└── 6
func (i1 *Int32) RemoveNode() []Noder {
	prev := i1.PrevSibling
	next := i1.NextSibling
	parent := i1.Parent
...
// NewInt32 creates a new node with the given data.
//
// Parameters:
//   - Data: The Data of the node.
//
// Returns:
//   - *Int32: A pointer to the newly created node. It is
//   never nil.
...
//
// Returns:
//   - *Int32: A pointer to the last sibling.
func (i1 *Int32) GetLastSibling() *Int32 {
	if i1.Parent != nil {
...
//
// Returns:
//   - *Int32: A pointer to the first sibling.
func (i1 *Int32) GetFirstSibling() *Int32 {
	if i1.Parent != nil {
...
func (i1 *Int32) GetChildren() []Noder {
	var children []Noder
...
func (i1 *Int32) HasChild(target *Int32) bool {
...
// Returns:
//   - []Noder: A slice of pointers to the children of the node.
func (i1 *Int32) delete_child(target *Int32) []Noder {
...
func (i1 *Int32) IsChildOf(target *Int32) bool {
	if target == nil {
		return false
	}
