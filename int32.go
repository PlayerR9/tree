...
// Int32NodeIterator is a pull-based iterator that iterates
// over the children of a Int32Node.
type Int32NodeIterator struct {
	parent, current *Int32Node
}
...
// node is never nil.
func (iter *Int32NodeIterator) Consume() (*Int32Node, error) {
	if iter.current == nil {
...
// Iterator implements the Int32Node interface.
//
// This function iterates over the children of the node, it is a pull-based iterator,
// and never returns nil.
func (tn *Int32Node) Iterator() common.Iterater[*Int32Node] {
	return &Int32NodeIterator{
		parent: tn,
		current: tn.FirstChild,
	}
}

// String implements the Int32Node interface.
...
// LinkWithParent implements the Int32Node interface.
//
...
// GetLeaves implements the Int32Node interface.
//
...
func (tn *Int32Node) GetLeaves() []*Int32Node {
	...
	stack := Stacker.NewLinkedStack[*Int32Node](tn)

	var leaves []*Int32Node
...
// Cleanup implements the Int32Node interface.
//
...
// GetAncestors implements the Int32Node interface.
//
...
//
// Finally, no nil nodes are returned.
func (tn *Int32Node) GetAncestors() []*Int32Node {
	var ancestors []*Int32Node
...
// IsLeaf implements the Int32Node interface.
func (tn *Int32Node) IsLeaf() bool {
	return tn.FirstChild == nil
}

// IsSingleton implements the Int32Node interface.
func (tn *Int32Node) IsSingleton() bool {
	return tn.FirstChild != nil && tn.FirstChild == tn.LastChild
}

// GetFirstChild implements the Int32Node interface.
func (tn *Int32Node) GetFirstChild() *Int32Node {
	return tn.FirstChild
}

// DeleteChild implements the Int32Node interface.
//
...
// Size implements the Int32Node interface.
//
...
func (tn *Int32Node) AddChild(child *Int32Node) {
	if child == nil {
		return
	}
...
//
// Returns:
//   - *Int32Node: A pointer to the newly created node. It is
//   never nil.
...
// same as the behaviors of the Int32Node.AddChild function.
//
// Parameters:
...
// Returns:
//   - []Int32Node: A slice of pointers to the children of the node.
func (tn *Int32Node) delete_child(target *Int32Node) []*Int32Node {
