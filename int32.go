...
//
// Moreover, the return value is always of type *Int32Node and never nil; unless the iterator
// has reached the end of the branch.
func (iter *Int32NodeIterator) Consume() (tree.Noder, error) {
	if iter.current == nil {
...
func (tn *Int32Node) GetParent() tree.Noder {
	return tn.Parent
}
...
func (tn *Int32Node) Cleanup() []tree.Noder {
...
func (tn *Int32Node) DeleteChild(target tree.Noder) []tree.Noder {
	if target == nil {
		return nil
	}

	tmp, ok := target.(*Int32Node)
	if !ok {
		return nil
	}
...
func (tn *Int32Node) GetFirstChild() tree.Noder {
	return tn.FirstChild
}

// AddChild implements the tree.Noder interface.
func (tn *Int32Node) AddChild(target tree.Noder) {
	if target == nil {
		return
	}
...
func (tn *Int32Node) LinkChildren(children []tree.Noder) {
...
func (tn *Int32Node) RemoveNode() []tree.Noder {
	prev := tn.PrevSibling
	next := tn.NextSibling
	parent := tn.Parent
...
func (tn *Int32Node) Copy() tree.Noder {
...
// values is guaranteed to be a non-nil node of type Int32Node.
func (tn *Int32Node) Iterator() common.Iterater[tree.Noder] {
...
func (tn *Int32Node) String() string {
	return fmt.Sprintf("Int32Node[%v]", tn.Data)
}
