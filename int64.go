...
// Int64NodeIterator is a pull-based iterator that iterates
// over the children of a Int64Node.
type Int64NodeIterator struct {
	parent, current *Int64Node
}
...
// node is never nil.
func (iter *Int64NodeIterator) Consume() (*Int64Node, error) {
	if iter.current == nil {
...
// Iterator implements the Int64Node interface.
//
// This function iterates over the children of the node, it is a pull-based iterator,
// and never returns nil.
func (tn *Int64Node) Iterator() common.Iterater[*Int64Node] {
	return &Int64NodeIterator{
		parent: tn,
		current: tn.FirstChild,
	}
}

// String implements the Int64Node interface.
...
// LinkWithParent implements the Int64Node interface.
//
...
// GetLeaves implements the Int64Node interface.
//
...
func (tn *Int64Node) GetLeaves() []*Int64Node {
	...
	stack := Stacker.NewLinkedStack[*Int64Node](tn)

	var leaves []*Int64Node
...
// Cleanup implements the Int64Node interface.
//
...
// GetAncestors implements the Int64Node interface.
//
...
//
// Finally, no nil nodes are returned.
func (tn *Int64Node) GetAncestors() []*Int64Node {
	var ancestors []*Int64Node
...
// IsLeaf implements the Int64Node interface.
func (tn *Int64Node) IsLeaf() bool {
	return tn.FirstChild == nil
}

// IsSingleton implements the Int64Node interface.
func (tn *Int64Node) IsSingleton() bool {
	return tn.FirstChild != nil && tn.FirstChild == tn.LastChild
}

// GetFirstChild implements the Int64Node interface.
func (tn *Int64Node) GetFirstChild() *Int64Node {
	return tn.FirstChild
}

// DeleteChild implements the Int64Node interface.
//
...
// Size implements the Int64Node interface.
//
...
func (tn *Int64Node) AddChild(child *Int64Node) {
	if child == nil {
		return
	}
