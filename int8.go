...
func (i1 *Int8) Iterator() common.Iterater[Noder] {
	return &Int8Iterator{
		parent: i1,
...
func (i1 *Int8) Copy() common.Copier {
...
func (i1 *Int8) SetParent(parent Noder) bool {
	if parent == nil {
		i1.Parent = nil
		return true
	}
...
func (i1 *Int8) LinkChildren(children []Noder) {
	if len(children) == 0 {
		return
	}
...
//
// Finally, no nil nodes are returned.
func (i1 *Int8) GetAncestors() []Noder {
	var ancestors []Noder
...
func (i1 *Int8) DeleteChild(target Noder) []Noder {
	if target == nil {
		return nil
	}
...
func (i1 *Int8) AddChild(child Noder) {
	if child == nil {
		return
	}
...
func (i1 *Int8) GetLastSibling() *Int8 {
	if i1.Parent != nil {
...
func (i1 *Int8) GetFirstSibling() *Int8 {
	if i1.Parent != nil {
...
func (i1 *Int8) AddChildren(children []*Int8) {
	if len(children) == 0 {
		return
	}
...
func (i1 *Int8) GetChildren() []Noder {
	var children []Noder
...
func (i1 *Int8) HasChild(target *Int8) bool {
...
// Returns:
//   - []Noder: A slice of pointers to the children of the node.
func (i1 *Int8) delete_child(target *Int8) []Noder {
...
func (i1 *Int8) IsChildOf(target *Int8) bool {
	if target == nil {
		return false
	}
