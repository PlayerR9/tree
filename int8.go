...
// node is never nil.
func (iter *Int8NodeIterator) Consume() (*Int8Node, error) {
	if iter.current == nil {
...
// String implements the Int8Node interface.
...
// LinkWithParent implements the Int8Node interface.
//
...
// GetLeaves implements the Int8Node interface.
//
...
func (tn *Int8Node) GetLeaves() []*Int8Node {
	...
	stack := Stacker.NewLinkedStack[*Int8Node](tn)
...
// Cleanup implements the Int8Node interface.
//
...
// GetAncestors implements the Int8Node interface.
//
...
//
// Finally, no nil nodes are returned.
func (tn *Int8Node) GetAncestors() []*Int8Node {
	var ancestors []*Int8Node
...
// IsLeaf implements the Int8Node interface.
func (tn *Int8Node) IsLeaf() bool {
	return tn.FirstChild == nil
}

// IsSingleton implements the Int8Node interface.
func (tn *Int8Node) IsSingleton() bool {
	return tn.FirstChild != nil && tn.FirstChild == tn.LastChild
}

// GetFirstChild implements the Int8Node interface.
func (tn *Int8Node) GetFirstChild() *Int8Node {
	return tn.FirstChild
}

// DeleteChild implements the Int8Node interface.
//
...
// Size implements the Int8Node interface.
//
...
func (tn *Int8Node) AddChild(child *Int8Node) {
	if child == nil {
		return
	}
