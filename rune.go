...
// LinkWithParent implements the RuneNode interface.
//
...
// GetLeaves implements the RuneNode interface.
//
...
func (tn *RuneNode) GetLeaves() []*RuneNode {
	...
	stack := Stacker.NewLinkedStack[*RuneNode](tn)
...
// GetAncestors implements the RuneNode interface.
//
...
// GetFirstChild implements the RuneNode interface.
func (tn *RuneNode) GetFirstChild() *RuneNode {
	return tn.FirstChild
}

// DeleteChild implements the RuneNode interface.
//
