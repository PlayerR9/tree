...
// LinkWithParent implements the UintNode interface.
//
...
// GetLeaves implements the UintNode interface.
//
...
func (tn *UintNode) GetLeaves() []*UintNode {
	...
	stack := Stacker.NewLinkedStack[*UintNode](tn)
...
// GetAncestors implements the UintNode interface.
//
...
// GetFirstChild implements the UintNode interface.
func (tn *UintNode) GetFirstChild() *UintNode {
	return tn.FirstChild
}

// DeleteChild implements the UintNode interface.
//
