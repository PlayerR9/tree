...
func (tn *Uint16) Iterator() common.Iterater[Noder] {
...
func (tn *Uint16) Copy() common.Copier {
...
func (tn *Uint16) SetParent(parent Noder) bool {
	if parent == nil {
		tn.Parent = nil
		return true
	}
...
func (tn *Uint16) GetParent() Noder {
	return tn.Parent
}
...
func (tn *Uint16) LinkChildren(children []Noder) {
	if len(children) == 0 {
		return
	}
...
func (tn *Uint16) GetLeaves() []Noder {
...
//
// Finally, no nil nodes are returned.
func (tn *Uint16) GetAncestors() []Noder {
	var ancestors []Noder
...
func (tn *Uint16) DeleteChild(target Noder) []Noder {
	if target == nil {
		return nil
	}
...
func (tn *Uint16) AddChild(child Noder) {
	if child == nil {
		return
	}
...
//	└── 5
//	└── 6
func (tn *Uint16) RemoveNode() []Noder {
	prev := tn.PrevSibling
	next := tn.NextSibling
	parent := tn.Parent
...
func (tn *Uint16) GetLastSibling() *Uint16 {
	if tn.Parent != nil {
...
func (tn *Uint16) GetFirstSibling() *Uint16 {
	if tn.Parent != nil {
...
func (tn *Uint16) AddChildren(children []*Uint16) {
	if len(children) == 0 {
		return
	}
...
func (tn *Uint16) GetChildren() []Noder {
	var children []Noder
...
func (tn *Uint16) HasChild(target *Uint16) bool {
...
// Returns:
//   - []Noder: A slice of pointers to the children of the node.
func (tn *Uint16) delete_child(target *Uint16) []Noder {
...
func (tn *Uint16) IsChildOf(target *Uint16) bool {
	if target == nil {
		return false
	}
