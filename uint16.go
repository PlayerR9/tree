...
// node is never nil.
func (iter *Uint16NodeIterator) Consume() (*Uint16Node, error) {
	if iter.current == nil {
...
// String implements the Uint16Node interface.
...
// IsSingleton implements the Uint16Node interface.
...
// Size implements the Uint16Node interface.
//
