...
//
// Returns:
//   - []*Uint64Node: A slice of pointers to the children of the node. Nil if the node has no children.
//
...
//
// Returns:
//   - []*Uint64Node: A slice of pointers to the leaves of the tree.
//
...
//
// Returns:
//   - []*Uint64Node: A slice of pointers to the ancestors of the node.
//
