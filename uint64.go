...
func (u *Uint64) Iterator() common.Iterater[Noder] {
...
func (u *Uint64) Copy() common.Copier {
...
func (u *Uint64) SetParent(parent Noder) bool {
	if parent == nil {
		u.Parent = nil
		return true
	}
...
func (u *Uint64) LinkChildren(children []Noder) {
	if len(children) == 0 {
		return
	}
...
//
// Finally, no nil nodes are returned.
func (u *Uint64) GetAncestors() []Noder {
	var ancestors []Noder
...
func (u *Uint64) DeleteChild(target Noder) []Noder {
	if target == nil {
		return nil
	}
...
func (u *Uint64) AddChild(child Noder) {
	if child == nil {
		return
	}
...
//	└── 5
//	└── 6
func (u *Uint64) RemoveNode() []Noder {
	prev := u.PrevSibling
	next := u.NextSibling
	parent := u.Parent
...
func (u *Uint64) GetLastSibling() *Uint64 {
	if u.Parent != nil {
...
func (u *Uint64) GetFirstSibling() *Uint64 {
	if u.Parent != nil {
...
func (u *Uint64) AddChildren(children []*Uint64) {
	if len(children) == 0 {
		return
	}
...
func (u *Uint64) GetChildren() []Noder {
	var children []Noder
...
func (u *Uint64) HasChild(target *Uint64) bool {
...
// Returns:
//   - []Noder: A slice of pointers to the children of the node.
func (u *Uint64) delete_child(target *Uint64) []Noder {
...
func (u *Uint64) IsChildOf(target *Uint64) bool {
	if target == nil {
		return false
	}
