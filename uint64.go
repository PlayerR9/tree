...
// Uint64NodeIterator is a pull-based iterator that iterates
// over the children of a Uint64Node.
type Uint64NodeIterator struct {
	parent, current *Uint64Node
}
...
// node is never nil.
func (iter *Uint64NodeIterator) Consume() (*Uint64Node, error) {
	if iter.current == nil {
...
// Iterator implements the Uint64Node interface.
//
// This function iterates over the children of the node, it is a pull-based iterator,
// and never returns nil.
func (tn *Uint64Node) Iterator() common.Iterater[*Uint64Node] {
	return &Uint64NodeIterator{
		parent: tn,
		current: tn.FirstChild,
	}
}

// String implements the Uint64Node interface.
...
// LinkWithParent implements the Uint64Node interface.
//
...
// GetLeaves implements the Uint64Node interface.
//
...
func (tn *Uint64Node) GetLeaves() []*Uint64Node {
	...
	stack := Stacker.NewLinkedStack[*Uint64Node](tn)

	var leaves []*Uint64Node
...
// Cleanup implements the Uint64Node interface.
//
...
// GetAncestors implements the Uint64Node interface.
//
...
//
// Finally, no nil nodes are returned.
func (tn *Uint64Node) GetAncestors() []*Uint64Node {
	var ancestors []*Uint64Node
...
// IsLeaf implements the Uint64Node interface.
func (tn *Uint64Node) IsLeaf() bool {
	return tn.FirstChild == nil
}

// IsSingleton implements the Uint64Node interface.
func (tn *Uint64Node) IsSingleton() bool {
	return tn.FirstChild != nil && tn.FirstChild == tn.LastChild
}

// GetFirstChild implements the Uint64Node interface.
func (tn *Uint64Node) GetFirstChild() *Uint64Node {
	return tn.FirstChild
}

// DeleteChild implements the Uint64Node interface.
//
...
// Size implements the Uint64Node interface.
//
...
func (tn *Uint64Node) AddChild(child *Uint64Node) {
	if child == nil {
		return
	}
