...
func (u *Uint8) Iterator() common.Iterater[Noder] {
...
func (u *Uint8) Copy() common.Copier {
...
func (u *Uint8) SetParent(parent Noder) bool {
	if parent == nil {
		u.Parent = nil
		return true
	}
...
func (u *Uint8) LinkChildren(children []Noder) {
	if len(children) == 0 {
		return
	}
...
//
// Finally, no nil nodes are returned.
func (u *Uint8) GetAncestors() []Noder {
	var ancestors []Noder
...
func (u *Uint8) DeleteChild(target Noder) []Noder {
	if target == nil {
		return nil
	}
...
func (u *Uint8) AddChild(child Noder) {
	if child == nil {
		return
	}
...
func (u *Uint8) GetLastSibling() *Uint8 {
	if u.Parent != nil {
...
func (u *Uint8) GetFirstSibling() *Uint8 {
	if u.Parent != nil {
...
func (u *Uint8) AddChildren(children []*Uint8) {
	if len(children) == 0 {
		return
	}
...
func (u *Uint8) GetChildren() []Noder {
	var children []Noder
...
func (u *Uint8) HasChild(target *Uint8) bool {
...
// Returns:
//   - []Noder: A slice of pointers to the children of the node.
func (u *Uint8) delete_child(target *Uint8) []Noder {
...
func (u *Uint8) IsChildOf(target *Uint8) bool {
	if target == nil {
		return false
	}
