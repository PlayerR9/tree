...
// node is never nil.
func (iter *UintptrNodeIterator) Consume() (*UintptrNode, error) {
	if iter.current == nil {
...
// Iterator implements the UintptrNode interface.
//
// This function iterates over the children of the node, it is a pull-based iterator,
// and never returns nil.
func (tn *UintptrNode) Iterator() common.Iterater[*UintptrNode] {
...
// String implements the UintptrNode interface.
...
// LinkWithParent implements the UintptrNode interface.
//
...
// GetLeaves implements the UintptrNode interface.
//
...
func (tn *UintptrNode) GetLeaves() []*UintptrNode {
	...
	stack := Stacker.NewLinkedStack[*UintptrNode](tn)

	var leaves []*UintptrNode
...
// Cleanup implements the UintptrNode interface.
//
...
// GetAncestors implements the UintptrNode interface.
//
...
//
// Finally, no nil nodes are returned.
func (tn *UintptrNode) GetAncestors() []*UintptrNode {
	var ancestors []*UintptrNode
...
// IsLeaf implements the UintptrNode interface.
func (tn *UintptrNode) IsLeaf() bool {
	return tn.FirstChild == nil
}

// IsSingleton implements the UintptrNode interface.
func (tn *UintptrNode) IsSingleton() bool {
	return tn.FirstChild != nil && tn.FirstChild == tn.LastChild
}

// GetFirstChild implements the UintptrNode interface.
func (tn *UintptrNode) GetFirstChild() *UintptrNode {
	return tn.FirstChild
}

// DeleteChild implements the UintptrNode interface.
//
...
// Size implements the UintptrNode interface.
//
...
func (tn *UintptrNode) AddChild(child *UintptrNode) {
	if child == nil {
		return
	}
